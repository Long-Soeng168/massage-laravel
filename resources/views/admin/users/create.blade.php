        ...
        <form class="w-full" action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <div>
                    ...
                    <x-text-input id="started_at" class="block w-full mt-1" type="date" name="started_at"
                        value="{{ old('started_at', \Carbon\Carbon::tomorrow()->toDateString()) }}" />
                ...
                <div>
                    ...
                    <x-text-input id="expired_at" class="block w-full mt-1" type="date" name="expired_at"
                ...
                <div class="grid grid-cols-4 gap-4">
                    @foreach ($roles as $role)
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="permission_{{ $role->id }}" name="roles[]"
                                value="{{ $role->name }}" class="mr-2" {{-- {{ in_array($permission->id, $rolePermissions) ? "checked" : '' }} --}}>
                            <label class="text-slate-800 dark:text-white"
