                            ...
                            <div class="grid grid-cols-2 gap-4 mb-4 ">
                                ...
                                <div class="col-span-2">
                                    <label for="commission"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">commission
                                        (%)</label>
                                    <input wire:key="{{ rand() }}" type="text" name="commission"
                                        id="commission" wire:model='newPublishercommission'
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-4 py-3 whitespace-nowrap">Commission (%)</th>
                ...
                @forelse ($items as $item)
                    <tr wire:key='{{ $item->id }}'
                        ...
                        @if ($editId == $item->id)
                            ...
                            <td>
                                <input type="text" wire:model='commission'
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[90%] p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </td>
                            <td></td>
                        @else
                            ...
                            <x-table-data class="capitalize"
                                value="{{ !empty($item->commission) ? $item->commission : 'N/A' }}" />
                            <x-table-data class="capitalize"
